		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
               ...
               <style>
                ...
                <h3 style="color: darkblue!important ; font-size: 25px !important">Manage all Files & Scan QR Code</h3>                
                <table style="margin-left:0%!important">
                    <tr>
                     ...
                     <td><a href="qr.jsp?reg=<%=id%>&&name=<%=name%>&&image=<%=image%>" style="color: Red; font-weight: bolder;">Generate QR Code</a></td>  
