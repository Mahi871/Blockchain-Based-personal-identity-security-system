...
<html lang="en">
  <head>
    <title>Block Chain Based Personal Identity Security System</title>
    <meta charset="utf-8">
	    	...
	    	<div class="container px-0">
	    		<div class="row no-gutters">
                    ...
                    h4{
		              ...
		              <h3 class="mb-2" style="color:brown;  margin-left: 120px;"><a href="single.html"></a>Block Chain Based Personal Identity Security System</h3>
                              <br><br>  <br><center><h3 style="font-family: cursive; color:darkblue; margin-left:120px; ">View User Request </h3>
                              <table>
                    <tr>
                        <td style='color:navy; font-weight: bold;'>User ID</td>
