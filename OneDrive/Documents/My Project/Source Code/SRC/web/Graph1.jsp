		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                     <div class="text p-4">
		              <h3 class="mb-2" style="color:brown; margin-left: 120px;"><a href="single.html"></a>Blockchain Based Personal Identity Security System</h3>
                              <br><br>   <br><center><h2 style="font-family: cursive; color:darkblue;margin-left: 120px;">Graph</h2></center><br>
		<style>
                    table{
                        line-height: 25px;
                        width: 50%;
