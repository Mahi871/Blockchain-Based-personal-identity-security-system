...
<%
                          ...
                          String fkey=request.getParameter("fkey");
                           %>
                            <form  action="QRAction1.jsp">
                                        <input type="hidden" id="text" value="<%=reg%>">
                                        <input type="hidden" id="text" value="<%=name%>">
                                        <input type="hidden" id="text" value="<%=image%>">
                                           <input type="hidden" id="text" value="<%=fkey%>">
                                        
                                      <img id='barcode' 
            src="https://api.qrserver.com/v1/create-qr-code/?data=reg=<%=reg%> name=<%=name%> image=<%=image%>&amp;size=250x250 fkey=<%=fkey%>" 
