			 ...
			 <nav id="colorlib-main-menu" style="text-align: center" role="navigation">
                            <ul style="margin-top: 20px; text-align: left; display: inline-block">					
                               <li class="colorlib"><span style="color: white" class="fa fa-home mr-3"></span><a href="Cloud_Home.jsp">Home</a></li>
		                         ...
		                         <li><span style="color: white" class="fa fa-paper-plane mr-3"></span><a href="ownerreq.jsp">User Uploaded Request</a></li>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                <div class="text p-4">
                                    <h3 class="mb-2" style="color:brown; margin-left: 120px;"><a href="single.html"></a>Block Chain Based Personal Identity Security System</h3><br>
			...
			<div>
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Hash Key</td>
                        ...
                        <td style='color:navy; font-weight: bold;'>File Key</td>
                         <td style='color:navy; font-weight: bold;'>Generate QR Code</td>
                    </tr>
                        ...
                        <td><a href="qr_1.jsp?reg=<%=id%>&&name=<%=name%>&&image=<%=image%>&&fkey=<%=fkey%>" style="color: Red; font-weight: bolder;">Generate QR Code</a></td>  
