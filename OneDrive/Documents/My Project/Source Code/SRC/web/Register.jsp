  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-white">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                  <div class="text p-4">
                                      <h3 class="mb-2" style="color: brown; margin-left: 120px;"><a href="#"></a><b>Blockchain Based Personal Identity Security System</b></h3>
		              <style>
      table{
          font-family: cambria;
          width: 50%;
      ...
      tr,td{
       ...
       <h2 style="margin-top: 20px; color:maroon; margin-left: 250px;font-family: cambria;font-weight: bold; font-size: 30px; color:darkblue">User Registration Page</h2><br>
