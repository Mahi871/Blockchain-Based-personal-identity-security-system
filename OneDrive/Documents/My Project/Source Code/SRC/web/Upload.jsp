		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
		 ...
		 <%
                ...
                <table>
                    ...
                    <tr><td style='color:blue; font-size: 20px;'><strong>Hash Key: </strong></td><td><input type="text" name="tkey" value="<%=tkey%>" style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:blue; font-size: 20px;'><strong>Upload Images/Files:</strong></td><td><input type="file" name="file" style="border-radius: 2px;"></td></tr>
