		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                <div class="text p-4">
                                    <h3 class="mb-2" style="color:brown;"><a href="single.html"></a>Block Chain Based Personal Identity Security System</h3><br>
			...
			<div>
                ...
                <table>
                    ...
                    <tr><td style='color:blue; font-size: 20px;'><strong>Hash Key: </strong></td><td><input type="text" name="tkey"  style="border-radius: 2px;"></td></tr>
